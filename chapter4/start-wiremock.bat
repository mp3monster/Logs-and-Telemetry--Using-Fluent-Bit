REM docker run -it --rm -p 8080:8080 -p 8443:8443 --name wiremock --volume .\wiremock\mappings.json:/home/wiremock/mappings/mappings.json wiremock/wiremock:2.35.0  --verbose
